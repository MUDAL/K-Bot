...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA0-WKUP     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(leftSpeedSensor_GPIO_Port, leftSpeedSensor_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(rightSpeedSensor_GPIO_Port, rightSpeedSensor_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_6|bluetoothRx_Pin);
